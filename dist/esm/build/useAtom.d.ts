import type { Atom, ExtractAtomArgs, ExtractAtomResult, ExtractAtomValue, WritableAtom, createStore } from 'jotai/vanilla';
export type Store = ReturnType<typeof createStore>;
interface Options {
    store?: Store;
}
export declare function useStore(options?: Options): {
